...
- `priceDB_data.csv` - 가격 히스토리 (c_id, category, date, price)
- `urgentDB_data.csv` - 급매 (c_id, category, original_price, urgent_price)
- `presaleDB_data.csv` - 분양 (c_id, category, original_price, presale_price)
