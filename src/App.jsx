  ...
  const PriceTablePage = () => {
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <CategoryTabs activeTab={activeTab} setActiveTab={(tab) => { setActiveTab(tab); setSelectedItem(null); }} colorScheme="default" />
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-5 gap-6">
              {topProperties.map((property) => (
                <PropertyCard key={property.id} property={property} category={category} type="category" />
              ))}
            </div>
          </section>
  ...
  const UrgentSalePage = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <CategoryTabs activeTab={activeTab} setActiveTab={setActiveTab} colorScheme="red" />
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-5 gap-6">
            {currentData.map((property) => (
              <PropertyCard key={property.id} property={property} category={activeTab} type="urgent" />
            ))}
          </div>
        </div>
      </div>
  ...
  const PresalePage = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <CategoryTabs activeTab={activeTab} setActiveTab={setActiveTab} colorScheme="category" />
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-5 gap-6">
            {currentData.map((property) => (
              <PropertyCard key={property.id} property={property} category={activeTab} type="presale" />
            ))}
          </div>
        </div>
      </div>
