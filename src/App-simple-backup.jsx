        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="flex gap-8">
            ...
            <button
              ...
              className={activePage === 'category' ? 'text-gray-900 font-bold border-b-2 border-gray-900' : 'text-gray-700 hover:text-gray-900'}
            >
              골프
            </button>
            <button
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">
              {currentPage === 'sise' && '시세표 페이지'}
              {currentPage === 'category' && `${selectedCategory === 'golf' ? '골프' : selectedCategory === 'condo' ? '콘도' : '피트니스'} 카테고리`}
              {currentPage === 'urgent' && '급매 페이지'}
              {currentPage === 'presale' && '분양 페이지'}
              {currentPage === 'inquiry' && '문의 페이지'}
            </h1>
            <p className="text-gray-600 mb-8">이 페이지는 구현 중입니다.</p>
            <button
              onClick={() => navigate('main')}
