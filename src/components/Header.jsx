        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="flex gap-8">
            ...
            <button
              ...
              className={currentPage === 'category' && selectedCategory === 'golf' ? 'text-gray-900 font-bold border-b-2 border-gray-900' : 'text-gray-700 hover:text-gray-900'}
            >
              골프
            </button>
            <button
              onClick={() => navigate('category', 'condo')}
              className={currentPage === 'category' && selectedCategory === 'condo' ? 'text-gray-900 font-bold border-b-2 border-gray-900' : 'text-gray-700 hover:text-gray-900'}
            >
              콘도
            </button>
            <button
              onClick={() => navigate('category', 'fitness')}
              className={currentPage === 'category' && selectedCategory === 'fitness' ? 'text-gray-900 font-bold border-b-2 border-gray-900' : 'text-gray-700 hover:text-gray-900'}
            >
              피트니스
            </button>
            <button
